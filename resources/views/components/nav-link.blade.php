...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 text-sm font-semibold leading-5 text-black-900 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out'
